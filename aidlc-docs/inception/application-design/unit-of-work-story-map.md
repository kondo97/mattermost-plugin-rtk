...
| US-007 | Custom Post Appears When Call Starts | Unit 4 | Unit 2 (custom_com.kondo97.mattermost-plugin-rtk_call_started WS event) |
...
| US-016 | Post Card Switches to "Ended" State When Call Ends | Unit 4 | Unit 2 (custom_com.kondo97.mattermost-plugin-rtk_call_ended WS event), Unit 3 (Redux update) |
...
| US-020 | Dismiss Incoming Call Notification | Unit 2 (POST /calls/{id}/dismiss) | Unit 3 (custom_com.kondo97.mattermost-plugin-rtk_notification_dismissed WS handler) |
...
| US-024 | DM/GM Ringing — Incoming Call Notification with Ignore and Join | Unit 3 | Unit 2 (custom_com.kondo97.mattermost-plugin-rtk_call_started WS event) |
